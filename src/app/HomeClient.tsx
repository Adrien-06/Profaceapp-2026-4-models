...
const MODELS: Record<ModelId, {
  ...
  realtor: {
    ...
    previewImg: '/hero/Design sans titre (6)/REAL ESTATE 1.png',
  },
  executive: {
    label: 'The Executive',
    ...
    previewImg: '/hero/Design sans titre (6)/FIRM 1.png',
  },
  analyst: {
    label: 'The Analyst',
    ...
    previewImg: '/hero/Design sans titre (6)/ACCOUNT 1.png',
  },
  innovator: {
    label: 'The Innovator',
    ...
    previewImg: '/hero/Design sans titre (6)/STARTUP 1.png',
  },
};

const GALLERY_IMAGES: Record<ModelId, { img: string; cap: string }[]> = {
  realtor: [
    { img: '/hero/Design sans titre (6)/REAL ESTATE 1.png', cap: 'Professional & Warm' },
    { img: '/hero/Design sans titre (6)/REAL ESTATE 2.png', cap: 'Client-Ready' },
    { img: '/hero/Design sans titre (6)/REAL ESTATE 3.png', cap: 'Trustworthy' },
    { img: '/hero/Design sans titre (6)/REAL ESTATE 4.png', cap: 'Approachable' },
    { img: '/hero/Design sans titre (6)/REAL ESTATE 5.png', cap: 'Expert' },
  ],
  executive: [
    { img: '/hero/Design sans titre (6)/FIRM 1.png', cap: 'Boardroom Authority' },
    { img: '/hero/Design sans titre (6)/FIRM 2.png', cap: 'Partner-Grade' },
    { img: '/hero/Design sans titre (6)/FIRM 3.png', cap: 'Corporate Confidence' },
    { img: '/hero/Design sans titre (6)/FIRM 4.png', cap: 'Courthouse Ready' },
    { img: '/hero/Design sans titre (6)/FIRM 5.png', cap: 'C-Suite Presence' },
  ],
  analyst: [
    { img: '/hero/Design sans titre (6)/ACCOUNT 1.png', cap: 'Precision & Trust' },
    { img: '/hero/Design sans titre (6)/ACCOUNT 2.png', cap: 'Fiduciary Confidence' },
    { img: '/hero/Design sans titre (6)/ACCOUNT 3.png', cap: 'Clean Corporate' },
    { img: '/hero/Design sans titre (6)/ACCOUNT 4.png', cap: 'Financial Authority' },
    { img: '/hero/Design sans titre (6)/ACCOUNT 5.png', cap: 'Neutral Mastery' },
  ],
  innovator: [
    { img: '/hero/Design sans titre (6)/STARTUP 1.png', cap: 'Forward Thinking' },
    { img: '/hero/Design sans titre (6)/STARTUP 2.png', cap: 'Startup Founder' },
    { img: '/hero/Design sans titre (6)/STARTUP 3.png', cap: 'Tech Visionary' },
    { img: '/hero/Design sans titre (6)/STARTUP 4.png', cap: 'Modern Disruptor' },
    { img: '/hero/Design sans titre (6)/STARTUP 5.png', cap: 'Creative Leader' },
  ],
};

const MOSAIC_IMAGES: { model: ModelId; img: string; label: string }[] = [
  { model: 'realtor',   img: '/hero/Design sans titre (6)/REAL ESTATE 1.png',  label: 'The Realtor' },
  { model: 'executive', img: '/hero/Design sans titre (6)/FIRM 2.png',         label: 'The Executive' },
  { model: 'analyst',   img: '/hero/Design sans titre (6)/ACCOUNT 3.png',      label: 'The Analyst' },
  { model: 'innovator', img: '/hero/Design sans titre (6)/STARTUP 5.png',      label: 'The Innovator' },
];
