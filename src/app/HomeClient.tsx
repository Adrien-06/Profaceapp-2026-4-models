...
const GALLERY_IMAGES: Record<ModelId, { img: string; cap: string }[]> = {
  realtor: [
    { img: '/hero/s1.png', cap: 'Warm & Approachable' },
    { img: '/hero/s2.png', cap: 'Client-Ready Smile' },
    { img: '/hero/s3.png', cap: 'Natural Light Portrait' },
    { img: '/hero/s4.png', cap: 'Property Professional' },
    { img: '/hero/s5.png', cap: 'Trusted Agent Look' },
  ],
  executive: [
    { img: '/hero/h1.webp', cap: 'Boardroom Authority' },
    { img: '/hero/h2.webp', cap: 'Partner-Grade Portrait' },
    { img: '/hero/h3.webp', cap: 'Corporate Confidence' },
    { img: '/hero/h4.webp', cap: 'Courthouse Ready' },
    { img: '/hero/h6.webp', cap: 'C-Suite Presence' },
  ],
  analyst: [
    { img: '/hero/v2.avif', cap: 'Precision & Trust' },
    { img: '/hero/v3.jpg',  cap: 'Fiduciary Confidence' },
    { img: '/hero/v4.jpg',  cap: 'Clean Corporate Look' },
    { img: '/hero/v6.jpg',  cap: 'Financial Authority' },
    { img: '/hero/v9.avif', cap: 'Neutral Mastery' },
  ],
  innovator: [
    { img: '/hero/h7.webp',  cap: 'Forward Thinking' },
    { img: '/hero/h8.webp',  cap: 'Startup Founder' },
    { img: '/hero/h9.webp',  cap: 'Tech Visionary' },
    { img: '/hero/h10.webp', cap: 'Modern Disruptor' },
    { img: '/hero/h11.webp', cap: 'Creative Leader' },
  ],
};

const MOSAIC_IMAGES: { model: ModelId; img: string; label: string }[] = [
  { model: 'realtor',   img: '/hero/s2.png',   label: 'The Realtor' },
  { model: 'executive', img: '/hero/h2.webp',  label: 'The Executive' },
  { model: 'analyst',   img: '/hero/v6.jpg',   label: 'The Analyst' },
  { model: 'innovator', img: '/hero/h8.webp',  label: 'The Innovator' },
];
